-- Migration 998: Remove packing_remarks from create_split_requests RPC
-- The packing_remarks column was dropped in migration 997.
-- This recreates the RPC without that column in both INSERT statements.
