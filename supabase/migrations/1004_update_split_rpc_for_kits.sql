-- ============================================================
-- Migration 1004: Update create_split_requests RPC for Kit Support
-- ============================================================
-- The item INSERT loops now include is_kit and is_unpacked columns,
-- and handle NULL quality/thickness for kit placeholder items.
-- ============================================================
